...
import { useGetAuthorsQuery } from "api/api.slice";
...
import autoresTableData from "layouts/autores/data/autoresTableData";
//Add-Edit-Document
...
function Autores() {
  const { data: dt, isLoading, isFetching, refetch } = useGetAuthorsQuery();
  ...
  const { columns, rows, newOrEdit, selectedId } = autoresTableData(
    dt,
    handleAceptarClick,
